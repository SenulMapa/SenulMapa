...
cs undergrad. building [jedach](https://jedach.com). colombo, sri lanka.

before finishing year 1 i shipped a production edge computer vision system — YOLOv8 + BYTETracker, 4 simultaneous camera streams, deployed on actual hardware for an actual logistics client. not a tutorial project.

---

### jedach

a software group building things that should exist.
